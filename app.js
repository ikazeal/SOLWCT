...
const I18N = {
  en: {
    ...
    "rewards.rulesHtml": "<b>Prize rules</b>: Top 5 share the prize pool — #1 40%, #2 20%, #3 10%, #4 5%, #5 5%. <b>Tax plan</b>: 70% of trading tax is used for rewards distribution. Remaining 43%: 20% buyback & burn, 10% liquidity. <a href=\"./whitepaper.html\">Details</a>.",
  ...
  zh: {
    ...
    "rewards.rulesHtml": "<b>获奖机制</b>：前 5 名瓜分奖池——第 1 名 40%，第 2 名 20%，第 3 名 10%，第 4/5 名各 5%。<b>税费规划</b>：交易税费的 70% 用于发放奖励；剩余 43%（20% 回购销毁、10% 流动性）。<a href=\"./whitepaper.html\">查看详情</a>。",
